...
#define OBJ_EVENT_GFX_BRANDON                    232
#define OBJ_EVENT_GFX_LINK_BRENDAN_RS            233
#define OBJ_EVENT_GFX_LINK_MAY_RS                234
...
#define NUM_OBJ_EVENT_BEFORE_OUTFITS             237
#define NUM_OBJ_EVENT_OUTFIT_FRAMES              8 

#define OBJ_EVENT_GFX_RED_NORMAL               NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_RED_ACRO_BIKE            NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_RED_SURFING              NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_RED_UNDERWATER           NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_RED_FIELD_MOVE           NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_RED_FISHING              NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_RED_WATERING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_RED_DECORATING           NUM_OBJ_EVENT_BEFORE_OUTFITS + (1 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_LEAF_NORMAL              NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_LEAF_ACRO_BIKE           NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_LEAF_SURFING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_LEAF_UNDERWATER          NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_LEAF_FIELD_MOVE          NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_LEAF_FISHING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_LEAF_WATERING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_LEAF_DECORATING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (2 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_RED_RBY_NORMAL           NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_RED_RBY_ACRO_BIKE        NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_RED_RBY_SURFING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_RED_RBY_UNDERWATER       NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_RED_RBY_FIELD_MOVE       NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_RED_RBY_FISHING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_RED_RBY_WATERING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_RED_RBY_DECORATING       NUM_OBJ_EVENT_BEFORE_OUTFITS + (3 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_BLUE_NORMAL              NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_BLUE_ACRO_BIKE           NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_BLUE_SURFING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_BLUE_UNDERWATER          NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_BLUE_FIELD_MOVE          NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_BLUE_FISHING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_BLUE_WATERING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_BLUE_DECORATING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (4 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_LUCAS_NORMAL             NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_LUCAS_ACRO_BIKE          NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_LUCAS_SURFING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_LUCAS_UNDERWATER         NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_LUCAS_FIELD_MOVE         NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_LUCAS_FISHING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_LUCAS_WATERING           NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_LUCAS_DECORATING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (5 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_BRENDAN_RS_NORMAL        NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_BRENDAN_RS_ACRO_BIKE     NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_BRENDAN_RS_SURFING       NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_BRENDAN_RS_UNDERWATER    NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_BRENDAN_RS_FIELD_MOVE    NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_BRENDAN_RS_FISHING       NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_BRENDAN_RS_WATERING      NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_BRENDAN_RS_DECORATING    NUM_OBJ_EVENT_BEFORE_OUTFITS + (6 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_MAY_RS_NORMAL            NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_MAY_RS_ACRO_BIKE         NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_MAY_RS_SURFING           NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_MAY_RS_UNDERWATER        NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_MAY_RS_FIELD_MOVE        NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_MAY_RS_FISHING           NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_MAY_RS_WATERING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_MAY_RS_DECORATING        NUM_OBJ_EVENT_BEFORE_OUTFITS + (7 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_BRENDAN_ORAS_NORMAL      NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_BRENDAN_ORAS_ACRO_BIKE   NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_BRENDAN_ORAS_SURFING     NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_BRENDAN_ORAS_UNDERWATER  NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_BRENDAN_ORAS_FIELD_MOVE  NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_BRENDAN_ORAS_FISHING     NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_BRENDAN_ORAS_WATERING    NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_BRENDAN_ORAS_DECORATING  NUM_OBJ_EVENT_BEFORE_OUTFITS + (8 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_MAY_ORAS_NORMAL          NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_MAY_ORAS_ACRO_BIKE       NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_MAY_ORAS_SURFING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_MAY_ORAS_UNDERWATER      NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_MAY_ORAS_FIELD_MOVE      NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_MAY_ORAS_FISHING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_MAY_ORAS_WATERING        NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_MAY_ORAS_DECORATING      NUM_OBJ_EVENT_BEFORE_OUTFITS + (9 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_DAWN_PT_NORMAL           NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_DAWN_PT_ACRO_BIKE        NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_DAWN_PT_SURFING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_DAWN_PT_UNDERWATER       NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_DAWN_PT_FIELD_MOVE       NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_DAWN_PT_FISHING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_DAWN_PT_WATERING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_DAWN_PT_DECORATING       NUM_OBJ_EVENT_BEFORE_OUTFITS + (10 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_HILBERT_NORMAL           NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_HILBERT_ACRO_BIKE        NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_HILBERT_SURFING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_HILBERT_UNDERWATER       NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_HILBERT_FIELD_MOVE       NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_HILBERT_FISHING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_HILBERT_WATERING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_HILBERT_DECORATING       NUM_OBJ_EVENT_BEFORE_OUTFITS + (11 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_ETHAN_NORMAL             NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_ETHAN_ACRO_BIKE          NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_ETHAN_SURFING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_ETHAN_UNDERWATER         NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_ETHAN_FIELD_MOVE         NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_ETHAN_FISHING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_ETHAN_WATERING           NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_ETHAN_DECORATING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (12 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_DAWN_NORMAL              NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_DAWN_ACRO_BIKE           NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_DAWN_SURFING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_DAWN_UNDERWATER          NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_DAWN_FIELD_MOVE          NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_DAWN_FISHING             NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_DAWN_WATERING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_DAWN_DECORATING          NUM_OBJ_EVENT_BEFORE_OUTFITS + (13 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7

#define OBJ_EVENT_GFX_GREEN_NORMAL             NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 0
#define OBJ_EVENT_GFX_GREEN_ACRO_BIKE          NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 1
#define OBJ_EVENT_GFX_GREEN_SURFING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 2
#define OBJ_EVENT_GFX_GREEN_UNDERWATER         NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 3
#define OBJ_EVENT_GFX_GREEN_FIELD_MOVE         NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 4
#define OBJ_EVENT_GFX_GREEN_FISHING            NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 5
#define OBJ_EVENT_GFX_GREEN_WATERING           NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 6
#define OBJ_EVENT_GFX_GREEN_DECORATING         NUM_OBJ_EVENT_BEFORE_OUTFITS + (14 * NUM_OBJ_EVENT_OUTFIT_FRAMES) + 7
...
#define NUM_OBJ_EVENT_GFX                        OBJ_EVENT_GFX_GREEN_DECORATING + 1
