...
const struct SpriteFrameImage gTrainerBackPicTable_Red_RBY[] =
{
    {gTrainerBackPic_Red_RBY + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Red_RBY + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Red_RBY + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Red_RBY + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Red_RBY + TRAINER_PIC_SIZE * 4, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_Blue[] =
{
    {gTrainerBackPic_Blue + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Blue + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Blue + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Blue + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Blue + TRAINER_PIC_SIZE * 4, TRAINER_PIC_SIZE},
};
...
const struct SpriteFrameImage gTrainerBackPicTable_Brendan_ORAS[] =
{
    {gTrainerBackPic_Brendan_ORAS + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Brendan_ORAS + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Brendan_ORAS + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Brendan_ORAS + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_May_ORAS[] =
{
    {gTrainerBackPic_May_ORAS + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_May_ORAS + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_May_ORAS + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_May_ORAS + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_Dawn_PT[] =
{
    {gTrainerBackPic_Dawn_PT + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Dawn_PT + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Dawn_PT + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Dawn_PT + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
