...
void FaintClearSetData(void)
{
    ...
    *(3 * 2 + gActiveBattler * 8 + (u8 *)(gBattleStruct->lastTakenMoveFrom) + 1) = 0;
    ...
    gBattleMons[gActiveBattler].types[0] = GetTypeBySpecies(gBattleMons[gActiveBattler].species, 1);
    gBattleMons[gActiveBattler].types[1] = GetTypeBySpecies(gBattleMons[gActiveBattler].species, 2);
